...
VALUES
	...
	(2,'my github','https://github.com/ZhaoGitHub1','link',NULL,0,0);
...
/*初始化登录信息username:admin password:123456*/
INSERT INTO `t_users` (`uid`, `username`, `password`, `email`, `home_url`, `screen_name`, `created`, `activated`, `logged`, `group_name`)
VALUES
	(1, 'admin', 'a66abb5684c45962d887564f08346e8d', '183479916@qq.com', NULL, 'admin', 1490756162, 0, 0, 'visitor');